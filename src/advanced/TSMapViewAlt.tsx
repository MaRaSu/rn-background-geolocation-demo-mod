...
const TSMapView = (props) => {
  ...
  const [mapCenter, setMapCenter] = React.useState({
	...
	const [mapStyle, setMapStyle] = React.useState<boolean>(true);
      ...
      {longPressOnMapPrompt()}
			<MapView
				...
				<Camera
					...
					followUserLocation={showsUserLocation}
				...
				/>
				<ShapeSource id="userpath_line" shape={featureCollection}>
					<LineLayer
					id="data_userpath_line"
					style={dataStyles.polyline}
					/>
					<CircleLayer
					id="data_userpath_circle"
					style={dataStyles.markers}
					/>
				</ShapeSource>
			</MapView>
    </View>
